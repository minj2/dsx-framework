...
var chunkPMJELSME_js = require('./chunk-PMJELSME.js');
...
var l=chunkTKGT252T_js.e(chunkX7RBQNLE_js.B());var{STORYBOOK_BASE_DIR:m,STORYBOOK_CONFIG_DIR:b,WEBPACK_STATS_FILE:u}=process.env;async function O(c){let{flags:t,input:f}=(0, l.default)(`
    ...
    `,{argv:c,description:"Trace utility for TurboSnap",flags:{statsFile:{type:"string",alias:"s",default:u||"storybook-static/preview-stats.json"},storybookBaseDir:{type:"string",alias:"b",default:m||"."},storybookConfigDir:{type:"string",alias:"c",default:b||".storybook"},untraced:{type:"string",alias:"u",isMultiple:!0},mode:{type:"string",alias:"m"}}}),d={log:console,options:{storybookBaseDir:t.storybookBaseDir,storybookConfigDir:t.storybookConfigDir,untraced:t.untraced,traceChanged:t.mode||!0},git:{rootPath:await chunkPMJELSME_js.v()},storybook:{baseDir:t.storybookBaseDir,configDir:t.storybookConfigDir}},p=await chunkLZXDNZPW_js.a(t.statsFile),e=f.map(o=>o.replace(/^\.\//,"")),i=e.find(o=>chunkPMJELSME_js.L(o));if(i)throw new Error(`Unable to trace package manifest file (${i}) as that would require diffing file contents.`);await chunkPMJELSME_js.Q(d,p,t.statsFile,e);}

exports.main = O;
//# sourceMappingURL=out.js.map
//# sourceMappingURL=trace-USGP7H5L.js.map
